...
- [ ] Describe Middleware?
\\ Middleware functions are functions that cnan execute code, make changes to req & res objects and can also end the request-response cycle. 

- [ ] Describe a Resource?
\\ 

- [ ] What can the API return to help clients know if a request was successful?
\\send back a 200 ok status code.
